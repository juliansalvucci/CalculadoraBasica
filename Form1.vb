Public Class Form1
    ...
    Private Sub btnBorrar_Click(sender As Object, e As EventArgs) Handles btnBorrar.Click
        ...
        If lblPantalla.Text.Length = 0 Then
            lblPantalla.Text = "0"
        End If
    End Sub
    ...
    Private Sub btnCalcular_Click(sender As Object, e As EventArgs) Handles btnCalcular.Click, btnSumar.Click, btnRestar.Click, btnMultiplicar.Click, btnDividir.Click, btnPotencia.Click, btnRaiz.Click, btn1x.Click, btnPorcentaje.Click
        ...
        If cantOperandos = 2 Then
            ...
            Select Case operador
                ...
                Case "1/x" : operando1 = 1 / operando1
